...
---@field type "Controllable" Used by Main.lua to identify mouse-controllable entities
local Controllable = {}
...
function Controllable:update(dt)
	...
	if love.keyboard.isDown(self.keys.up) then keyboardInputY, keyboardActive = keyboardInputY - 1, true end
	if love.keyboard.isDown(self.keys.down) then keyboardInputY, keyboardActive = keyboardInputY + 1, true end
	if love.keyboard.isDown(self.keys.left) then keyboardInputX, keyboardActive = keyboardInputX - 1, true end
	if love.keyboard.isDown(self.keys.right) then keyboardInputX, keyboardActive = keyboardInputX + 1, true end
