	...
	components = {
...

		{
			...
			tags = {
				...
				splash = {
					{ target = "scaleX", from = 1.25, to = 1, duration = 0.75, curve = "OutBack" },
					{ target = "scaleY", from = 0.75, to = 1, duration = 0.5, curve = "OutBack" },
				},
				pickup = { { target = "tintMix", from = 0.5, to = 0, duration = 0.5, curve = "OutCubic" } },
			},
		},
