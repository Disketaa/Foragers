...
|---|---|---|---|---|
| **spritesheet** | Quad animation + frame rendering. Each animation accepts per-frame `duration` hold weights (frame `i` holds `duration[i]/speed`; see data-format.md) | `columns`, `rows`, `animations`, `tags` | STATE_CHANGED (5) | ANIM_FRAME |
