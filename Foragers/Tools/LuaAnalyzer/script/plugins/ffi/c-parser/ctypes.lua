...
local register_decls = function (lst, ids, spec) return register_many(register_decl_item, lst, ids, spec) end
...
local register_typedefs = function (lst, item) return register_many(register_typedef_item, lst, item.ids, item.spec) end
