...
---
---@return number pitch # The pitch, where 1 is normal.
...
---
---@return number volume # The volume of the Source, where 1 is normal volume.
...
---
---@param volume number # The volume for a Source, where 1 is normal volume. Volume cannot be raised above 1.
