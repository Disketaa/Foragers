...
---
---In versions prior to 11, color component values were within the range of 0 to 255 instead of 0 to 1.
---
...
---
---In versions prior to 0.9, LÖVE expects ISO 8859-1 encoding for the glyphs string.
---
---
...
---
---In versions prior to 11, color and byte component values were within the range of 0 to 255 instead of 0 to 1.
---
---
...
---
---In version 0.9.2 and earlier, wrapping was implemented by breaking up words by spaces and putting them back together to make sure things fit nicely within the limit provided. However, due to the way this is done, extra spaces between words would end up missing when printed on the screen, and some lines could overflow past the provided wrap limit. In version 0.10 and newer this is no longer the case.
---
---In versions prior to 11, color and byte component values were within the range of 0 to 255 instead of 0 to 1.
---
---
...
---
---Calling reset makes the current drawing color white, the current background color black, disables any active color component masks, disables wireframe mode and resets the current graphics transformation to the origin. It also sets both the point and line drawing modes to smooth and their sizes to 1.
---
---
...
---
---This will be the value previously set by Font:setLineHeight, or 1 by default.
---
---
...
---
---Gets the series of sizes by which the sprite is scaled. 1 is normal size. The particle system will interpolate between each size evenly over the particle's lifetime.
---
---
...
---
---Sets the mipmap filter mode for a Texture. Prior to 11 this method only worked on Images.
---
---Mipmapping is useful when drawing a texture at a reduced scale. It can improve performance and reduce aliasing issues.
---
---In created with the mipmaps flag enabled for the mipmap filter to have any effect. In versions prior to 0.10 it's best to call this method directly after creating the image with love.graphics.newImage, to avoid bugs in certain graphics drivers.
---
