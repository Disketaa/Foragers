...
---The rendering API was originally built on top of OpenGL ES 2, and it uses a subset of the
---OpenGL computer graphics rendering API for rendering 2D and 3D computer
---graphics. Our current target is OpenGLES 3 with fallbacks to 2 on some platforms.
--- It is possible to create materials and write shaders that
---require features not in OpenGL ES 2, but those will not work cross platform.
---@class render
render = {}
