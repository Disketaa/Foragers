...
---
---The weight is a number between 0 and 1 controlling the general "shape" of the sound emitted. 0 results in a completely omnidirectional sound that can be heard from all directions.
---
---1 results in a full dipole shape that can be heard only from the front and back.
---
...
---
---@return number weight # The dipole weight.  0 is omnidirectional, 1 is a dipole, 0.5 is cardioid.
