...
---
---This means that lines of text rendered with a scale of 1 come out to 1 unit (meter) tall.
---
...
---
---However, a more convenient option is to set the pixel density of the font to 1 when doing 2D rendering to make the font's size match up with the pixels of the canvas.
---
...
---
---### NOTE:
---When using LÖVR's default projection (reverse Z with infinite far plane) the default depth test is `gequal`, depth values of 0 are on the far plane and depth values of 1 are on the near plane, closer to the camera.
---
