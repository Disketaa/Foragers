...
---
---High DPI windows will usually return 2 to indicate that there are 2 pixels for every window coordinate in each axis.
---
---On a normal display, 1 is returned, indicating that window coordinates match up with pixels 1:1.
---
