...
--
--OpenGL ES 2 graphics API. (deprecated on iOS and tvOS)
--
---@source UnityEngine.CoreModule.dll
---@field OpenGLES2 UnityEngine.Rendering.GraphicsDeviceType
--
--OpenGL ES 3 graphics API. (deprecated on iOS and tvOS)
--
---@source UnityEngine.CoreModule.dll
...
--
--SHADER_API_ES30 is set when the Graphics API is OpenGL ES 3 and the minimum supported OpenGL ES 3 version is OpenGL ES 3.
--
---@source UnityEngine.CoreModule.dll
