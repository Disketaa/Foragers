...
--
--Returns a floating-point value between 0 and 1, indicating the progress of uploading body data to the server.
--
---@source UnityEngine.UnityWebRequestModule.dll
...
--
--Returns a floating-point value between 0 and 1, indicating the progress of downloading body data from the server. (Read Only)
--
---@source UnityEngine.UnityWebRequestModule.dll
