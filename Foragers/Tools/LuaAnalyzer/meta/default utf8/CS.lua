...
--    You can change this behaviour back to how it was pre-3.7 using this flag.
--
...
--
--Number of steps the slider should be divided into. For example 5 means possible values of 0, 0.25, 0.5, 0.75, and 1.
--
...
--    http://www.tasharen.com/forum/index.php?topic=13965
--
